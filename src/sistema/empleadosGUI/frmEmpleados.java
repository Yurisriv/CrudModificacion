...
public class frmEmpleados extends javax.swing.JFrame {
    ...
    public frmEmpleados() {
        ...
        String[] titulos= {"ID","Nombre","Correo","Ciudad"};
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        String strSentenciaInsert= String.format("INSERT INTO Empleados (ID, Nombre, Correo,Ciudad)"
                + "VALUES (null, '%s','%s','%s')", oEmpleados.getNombre(), oEmpleados.getCorreo(),oEmpleados.getCiudad());
    ...
    private void tblEmpleadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblEmpleadosMouseClicked
        ...
        if(evt.getClickCount()==1){
            ...
            txtCiudad.setText(receptor.getModel().getValueAt(receptor.getSelectedRow(), 3).toString());
        }
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        String strSentenciaEdit= String.format("UPDATE Empleados SET Nombre='%s',"
                + "Correo='%s' , Ciudad='%s' WHERE ID = %d", oEmpleados.getNombre(), oEmpleados.getCorreo(), oEmpleados.getCiudad(), oEmpleados.getID());
    ...
    public void mostrarDatos(){
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                Object[] oUsuario={resultado.getString("ID"),resultado.getString("Nombre"),resultado.getString("Correo"),resultado.getString("Ciudad")};
    ...
    public empleadosBL recuperarDatosGUI(){
        ...
        oEmpleados.setCiudad(txtCiudad.getText());
